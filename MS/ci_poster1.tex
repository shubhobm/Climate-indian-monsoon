...
%----------------------------------------------------------------------------------------
%
{\includegraphics[height=5em]{umnlogo1}} % First university/lab logo on the left
{\huge{\bf\textsc{Identifying Driving Factors Behind Indian Monsoon Precipitation using Model Selection based on Data Depth}}\vspace{0.5em}} % Poster title
{\textsc{ Subhabrata Majumdar, Lindsey Dietz and Snigdhansu Chatterjee }}
{\includegraphics[height=5em]{umnlogo1}} % Second university/lab logo on the right
