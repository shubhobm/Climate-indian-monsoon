...
%  background=shade-tb,
  ...
  % Title
  {\bf\textsc{Identifying Driving Factors Behind Indian Monsoon Precipitation using Model Selection based on Data Depth}\vspace{0.5em}}
  % Authors
  {Subhabrata Majumdar, Lindsey Dietz and Snigdhansu Chatterjee}
  % Affiliation
...
\item Large number of predictors, hence huge number of possible models: $2^p$ models when number of predictors is $p$.
\end{itemize}
\vspace{.3em}
